    ...
    return (
      <MainLayout className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <Loader2 className="h-12 w-12 animate-spin mx-auto mb-4 text-[#E50914]" />
  ...
  return (
    <MainLayout>
      <div className="space-y-8">
        <div className="glass-morphism p-6 rounded-lg" style={{ background: "linear-gradient(to right, rgba(229, 9, 20, 0.1), rgba(229, 9, 20, 0.05))" }}>
          <div className="flex items-center gap-3">
            <FilmIcon className="h-8 w-8 text-[#E50914]" />
            <div>
              <h1 className="text-3xl font-bold text-gradient mb-2" style={{ background: "linear-gradient(to right, #E50914, #ff5b61)" }}>Netflix Dashboard</h1>
              <p className="text-muted-foreground">Manage your Netflix Premium account system</p>
            </div>
          </div>
        </div>

        <Tabs defaultValue="admin" className="w-full">
          <TabsList className="w-full mb-6 grid grid-cols-2 md:grid-cols-7 h-auto p-1 glass-morphism shadow-lg" style={{ background: "linear-gradient(to right, rgba(229, 9, 20, 0.1), rgba(229, 9, 20, 0.05))" }}>
